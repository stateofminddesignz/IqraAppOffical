...
const DhikrCard = ({ imageUrl, title, description,}) => {
    ...
    <div className="w-60 mt-6  m-auto">
    <div
    className=" border-red-50  rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700  ">
    <a href="#!">
      <img
        className="rounded-t-lg object-cover w-60 h-60  "
        src={imageUrl}
        alt={title} />
    </a>
    <div className="p-6">
